...
with open("./resources/binary_file.bin", "wb") as myFile: #when opening files using with, they will close automatically at the end of the block
...
with open("./resources/binary_file.bin", "rb") as myFile2:
